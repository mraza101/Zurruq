  ...
  if (contactForm && enquiryType) {
    ...
    contactForm.addEventListener('submit', (e) => {
      ...
      if (validateForm(contactForm)) {
        ...
        setTimeout(() => {
          contactForm.innerHTML = '<div style="padding: 40px; text-align: center; background: var(--cream); border-radius: var(--radius-md); border: 0.5px solid var(--border);"><h3>Message Sent</h3><p>Thank you for your enquiry. We will respond within 1 business day.</p></div>';
        }, 1000);
      }
    });
  }
